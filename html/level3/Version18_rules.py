...
****************************************TYPES OF ERRORS*********************************
Whenever the server gives an "Invalid Syntax" type of error then :

1. Check if you are using any predefined keywords of any different language (eg : for, return, scanf, etc.).
2. Check if you are including library files of any predefined language.  
3. Check if you are using any type of comments.  
